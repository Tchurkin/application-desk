...
export default async function JoinPage(props: PageProps<"/join/[token]">) {
  ...
  const info = data as { valid: boolean; role?: "view" | "suggest"; needs_password?: boolean; desk_title?: string } | null;
      ...
      {!info?.valid ? (
        ...
        <>
          ...
          <p className="mb-6 text-muted">
            You&apos;ve been invited to {info.role === "suggest" ? "read and suggest edits to" : "read"} these college essays.
